...
df = pd.read_csv(r"C:\Twitter_project_rev\bronze_tweets_raw.csv")

print("Starting Tweets Producer...")
...
print(f"Successfully sent {record_count} records to Tweet Event Hub.")
